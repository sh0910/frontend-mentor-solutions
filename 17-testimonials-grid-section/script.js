...
const markup = testimonials
  .map((testimonial, i) => {
    return `
		<section class="testimonial testimonial--${i + 1}">
			<div class="testimonial__author">
				<img src="./images/${testimonial.img}" alt="${
      testimonial.name
    }" class="testimonial__img"/>
				<div>
					<p class="testimonial__name"> ${testimonial.name}</p>
					<p class="testimonial__verified">${
            testimonial.verifiedGraduate && "Verified Graduate"
          }</p>
				</div>
			</div>
